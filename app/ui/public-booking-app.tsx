...
export function PublicBookingApp({ data, today }: { data: PublicBookingData; today: string }) {
  ...
  function updateMembershipLookupName(value: string) {
    setMembershipLookupName(value);
