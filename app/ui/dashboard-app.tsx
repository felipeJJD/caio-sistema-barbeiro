...
function TeamHub({ data, post, pending }: { data: DashboardData; post: Post; pending: boolean }) {
  const [view, setView] = useState<"Resultados" | "Usuários e convites">("Resultados");
  return <>
    ...
    {view === "Resultados" ? <Team data={data} post={post} pending={pending} /> : <UserInvites />}
  </>;
}
