...
export const helpTopics = [
  ...
  { id: "commissions", terms: ["comissao", "comissoes", "repasse", "repasses"], answer: "As comissões seguem o valor ou percentual configurado para cada atendimento e produto. Você acompanha os valores por profissional em Equipe. Gorjetas vão integralmente para quem atendeu.", section: "Equipe", label: "Ver comissões", owner: true },
