...
export const organizations = sqliteTable("organizations", {
  ...
  estimatedMonthlyClients: integer("estimated_monthly_clients").notNull().default(0),
  estimatedMonthlyWhatsappContacts: integer("estimated_monthly_whatsapp_contacts").notNull().default(0),
  estimatedProfessionals: integer("estimated_professionals").notNull().default(0),
  serviceMode: text("service_mode").notNull().default(""),
  automationGoal: text("automation_goal").notNull().default(""),
...
export const whatsappConnections = sqliteTable("whatsapp_connections", {
  ...
  onboardingMode: text("onboarding_mode").notNull().default("cloud"),
  ...
  encryptedRegistrationPin: text("encrypted_registration_pin").notNull().default(""),
  registrationPinIv: text("registration_pin_iv").notNull().default(""),
...
export const whatsappAutomationSettings = sqliteTable("whatsapp_automation_settings", {
  ...
  economyMode: integer("economy_mode", { mode: "boolean" }).notNull().default(true),
  bookingLinkFirst: integer("booking_link_first", { mode: "boolean" }).notNull().default(true),
  spamFilterEnabled: integer("spam_filter_enabled", { mode: "boolean" }).notNull().default(true),
  aiFallbackEnabled: integer("ai_fallback_enabled", { mode: "boolean" }).notNull().default(true),
  greetingText: text("greeting_text").notNull().default(""),
  handoffText: text("handoff_text").notNull().default(""),
...
export const whatsappConversations = sqliteTable("whatsapp_conversations", {
  ...
  botState: text("bot_state").notNull().default(""),
  botContextJson: text("bot_context_json").notNull().default("{}"),
  lastIntent: text("last_intent").notNull().default(""),
  lastInboundPreview: text("last_inbound_preview").notNull().default(""),
